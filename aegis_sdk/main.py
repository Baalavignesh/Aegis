"""
AegisBot — Usage proof for sentinel-guardrails (Database Polling edition).
...
class AegisBotAgent:
    """The AegisBot agent — policy-decorated class."""
    pass
...
def main():
    print("=" * 70)
    print("  Sentinel Guardrails — AegisBot DB Polling Demo")
    print("=" * 70)
